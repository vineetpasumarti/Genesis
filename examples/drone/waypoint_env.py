...
class HoverEnv:
    ...
    def _resample_commands(self, envs_idx):
        for idx in envs_idx:
            # Corrected sequence
            new_index = (self.current_target_index[idx] + 1) % len(self.target_locations)
            self.current_target_index[idx] = new_index
            self.commands[idx] = self.target_locations[new_index]  # Use UPDATED index
